 ...
 * @author Mahmo
 */
public class AfficherLettreMotivation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession(true);
            ...
            LettreMotivation lettre  = letudiant.getLettre();
             session.setAttribute("LEttreMotivation", lettre);
             request.getRequestDispatcher("afficherLettreMotivation.jsp").forward(request, response);
